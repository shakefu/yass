...
> `context/yass-reference.md`, and `context/GUIDANCE.md`. Everything below is a
> **proposal** offered for adoption into those three files; until it lands there
> it binds nothing and states no settled goal of the language.
